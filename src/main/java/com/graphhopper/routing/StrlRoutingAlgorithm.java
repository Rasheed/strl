 ...
 * @author Peter Karich
 */
public class StrlRoutingAlgorithm extends AbstractBidirAlgo
{
    ...
    public StrlRoutingAlgorithm( Graph graph, FlagEncoder encoder, Weighting weighting, TraversalMode tMode )
    {
    ...
    void setFromDataStructures( StrlRoutingAlgorithm dijkstra )
    {
    ...
    void setToDataStructures( StrlRoutingAlgorithm dijkstra )
    {
