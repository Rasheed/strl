...
public class GraphHopperStorage implements GraphStorage
{
    ...
    // edge memory layout:
    protected int E_NODEA, E_NODEB, E_LINKA, E_LINKB, E_DIST, E_FLAGS, E_GEO, E_NAME, E_WALKABLE;
    /**
    ...
    public EdgeIteratorState edge( int a, int b )
    {
        ...
        {
            iter.setWalkability(extStorage.getDefaultEdgeFieldValue());
        }
        iter.next();
        return iter;
    }
    ...
    EdgeIteratorState copyProperties( EdgeIteratorState from, EdgeIteratorState to )
    {
        ...
        if (E_WALKABLE >= 0)
            to.setWalkability(from.getWalkability());
        return to;
    }
...
//        edges.trimTo(edgeCap * 4);
    ...
    protected void initStorage()
    {
        ...
        E_WALKABLE = nextEdgeEntryIndex(4);
